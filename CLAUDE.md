...
- Keep changes aligned with the repo goal: maintain `STATE_OF_THE_ART.md`, maintain `REPO_SHAPE.md`, and keep the repo's managed surfaces aligned with daily research on spec-driven development.
