...
grep -q 'GH_OBSERVATORY_AUTOMATION_TOKEN' "${ROOT_DIR}/.github/workflows/advance-observatory.yml"
grep -q 'GH_OBSERVATORY_AUTOMATION_TOKEN' "${ROOT_DIR}/.github/workflows/watchdog-observatory.yml"
...
grep -q 'gh secret set CODEX_AUTH_JSON_B64 --env observatory' "${ROOT_DIR}/.github/workflows/advance-observatory.yml"
grep -q 'gh secret set CODEX_AUTH_JSON_B64 --env observatory' "${ROOT_DIR}/.github/workflows/watchdog-observatory.yml"
...
grep -q 'runs-on: ubuntu-latest' "${ROOT_DIR}/.github/workflows/advance-observatory.yml"
grep -q 'runs-on: ubuntu-latest' "${ROOT_DIR}/.github/workflows/watchdog-observatory.yml"
