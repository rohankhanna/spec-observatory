...
grep -q 'environment: observatory' "${ROOT_DIR}/.github/workflows/advance-observatory.yml"
grep -q 'environment: observatory' "${ROOT_DIR}/.github/workflows/watchdog-observatory.yml"
