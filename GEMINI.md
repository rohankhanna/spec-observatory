...
- Before substantive work, read `README.md`, `PROJECT_INTENT.md`, `specs/PRODUCT_SPEC.md`, `specs/RESEARCH_SCOPE_SPEC.md`, `specs/REPO_SHAPE_SPEC.md`, `specs/DAILY_REFRESH_SPEC.md`, and `STATE_OF_THE_ART.md`.
...
- Treat workflow files, shell scripts, auth bootstrapping, and `AGENTS.md` plus mirrors as controller surfaces that should change deliberately, not as part of the routine daily restructuring loop.
